Pod::Spec.new do |s|
  s.name        = 'UBiXMerakSDK-STO'
  s.version     = '2.12.0.1102'
  s.license     = 'MIT'
  s.authors     = {'ubixai' => 'pub.dev@ubixai.com'}
  s.homepage    = 'https://github.com/ubixai/UBiXAdSDK_STO'
  s.source      = { :git => 'https://github.com/ubixai/UBiXAdSDK_STO.git', :tag => s.version.to_s}
  s.summary     = 'UBiX Merak Ad SDK for iOS. For customized'
  s.description = 'UBiX 天璇广告SDK iOS端 定制版.'
